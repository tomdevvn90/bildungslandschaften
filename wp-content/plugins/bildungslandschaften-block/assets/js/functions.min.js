...
jQuery(function ($) {
  ...
  const MapSelector = () => {
    ...
    $selectorsPointerItem.on('mouseenter click', function (e) {
      ...
      $btnMapSelectorTextWrap.text(data === null || data === void 0 ? void 0 : data.title);
      $btnMapSelector.attr('href', data === null || data === void 0 ? void 0 : data.link);
    });
    $selectorsPointerItem.on('click', function (e) {
      e.preventDefault();
      const data = $(this).data('map');

      if (data !== null && data !== void 0 && data.link) {
