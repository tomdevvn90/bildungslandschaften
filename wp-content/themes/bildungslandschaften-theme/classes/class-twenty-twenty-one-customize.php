		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'bildungslandschaften' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'bildungslandschaften' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'bildungslandschaften' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'bildungslandschaften' ),
						'full'    => esc_html__( 'Full text', 'bildungslandschaften' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new Twenty_Twenty_One_Customize_Color_Control(
					...
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'bildungslandschaften' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
