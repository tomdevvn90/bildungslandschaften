		...
		<div class="entry-content">
			...
			wp_link_pages(
				array(
					...
					'pagelink' => esc_html__( 'Page %', 'bildungslandschaften' ),
				)
			);
			?>
		</div><!-- .entry-content -->
		...
		<footer class="entry-footer default-max-width">
			...
			if ( wp_get_post_parent_id( $post ) ) {
				...
				printf(
					...
					esc_html__( 'Published in %s', 'bildungslandschaften' ),
			...
			if ( $metadata ) {
				printf(
					...
					esc_html_x( 'Full size', 'Used before full size attachment link.', 'bildungslandschaften' ), // phpcs:ignore WordPress.Security.EscapeOutput
