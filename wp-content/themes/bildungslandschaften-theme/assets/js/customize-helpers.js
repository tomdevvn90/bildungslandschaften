 ...
 */
function bildungslandschaftenGetHexLum( hex ) { // jshint ignore:line
	var rgb = bildungslandschaftenGetRgbFromHex( hex );
 ...
 */
function bildungslandschaftenGetRgbFromHex( hex ) {
